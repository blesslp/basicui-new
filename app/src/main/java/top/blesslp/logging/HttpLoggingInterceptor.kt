        ...
        if (logHeaders) {
            ...
            if (!logBody || requestBody == null) {
                ...
                if (requestBody is MultipartBody) {
                    ...
                    for (part in parts) {
                        if (TextUtils.equals("multipart", part.body.contentType()?.type)) {
                            temp.addPart(part.headers,RequestBody.create("multipart/form-data".toMediaType(),"文件"))
                        }else{
                            temp.addPart(part)
                        }
                    }
                    temp.build().writeTo(buffer)
                }else {
