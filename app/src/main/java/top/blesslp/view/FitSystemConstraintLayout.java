...
public class FitSystemConstraintLayout extends ConstraintLayout implements IWindowInsetLayout {
    ...
    public FitSystemConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FitSystemConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
