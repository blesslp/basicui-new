...
public class FitsSystemLinearLayout extends QMUILinearLayout implements IWindowInsetLayout {
    protected QMUIWindowInsetHelper mQMUIWindowInsetHelper;

    public FitsSystemLinearLayout(Context context) {
        this(context, null);
    }

    public FitsSystemLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FitsSystemLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
